...
$follow_srl = str_replace ( ".", "", (microtime ( get_as_float )) );
...
if ($count > 0) {
	...
	$sql = "INSERT INTO $tb_name (follow_srl, follow_member_srl, member_srl, follow_date)
		VALUES ('$follow_srl','$follow_member_srl','$member_srl', UNIX_TIMESTAMP())";
